                  ...
                  <tr>
                     ...
                     <td>
                        <div class="btn-group" role="group">
                           ...
                           <?php if($c['complaint_status_id'] == 4){ ?>
                              <a class="dropdown-item text-success" href="javascript:void(0);" onclick="cambiar_status(<?= $c['complaint_id']; ?>, 5);">
                                 <i class="fa fa-check-circle" aria-hidden="true"></i> <?= lang('Home.Cerrar');?>
                              </a>
                           <?php } ?>
                           </div>
                        </div>
