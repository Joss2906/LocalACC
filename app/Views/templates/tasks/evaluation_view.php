                  ...
                  <tr>
                     ...
                     <td>
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control col-md-3" name="average_productivity" onkeypress="return justIntegers(event);" maxlength="3" placeholder="0">
                        </div>
                        <div class="form-group">
                           <textarea name="commentary_productivity" cols="30" rows="5" maxlength="999" onkeyup="this.value=caracteres_signos_numeros_validos(this.value)" placeholder="Escribe un comentario"></textarea>
                        </div>
                     </td>
                     <td>
                        <div class="form-group">
                           <input type="text" class="form-control col-md-3" name="average_quality" onkeypress="return justIntegers(event);" maxlength="3" placeholder="0">
                        </div>
                        <div class="form-group">
                           <textarea name="commentary_quality" cols="30" rows="5" maxlength="999" onkeyup="this.value=caracteres_signos_numeros_validos(this.value)" placeholder="Escribe un comentario"></textarea>
                        </div>
                     </td>
                     <td>
                        <div class="form-group">
                           <input type="text" class="form-control col-md-3" name="average_innovation" onkeypress="return justIntegers(event);" maxlength="3" placeholder="0">
                        </div>
                        <div class="form-group">
                           <textarea name="commentary_innovation" cols="30" rows="5" maxlength="999" onkeyup="this.value=caracteres_signos_numeros_validos(this.value)" placeholder="Escribe un comentario"></textarea>
                        </div>
                     </td>
                     <td>
                        <div class="form-group">
                           <input type="text" class="form-control col-md-3" name="average_service" onkeypress="return justIntegers(event);" maxlength="3" placeholder="0">
                        </div>
                        <div class="form-group">
                           <textarea name="commentary_service" cols="30" rows="5" maxlength="999" onkeyup="this.value=caracteres_signos_numeros_validos(this.value)" placeholder="Escribe un comentario"></textarea>
                        </div>
                     </td>
                     <td>
