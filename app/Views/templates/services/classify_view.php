	...
	<div class="iq-card-body">
		...
		<div class="col-md-12 row">
			<div class="col-md-12 table-responsive">
				<h5><?= lang('Home.Servicios sin asignar');?></h5>
				<table id="datatable-asignar" class="table table-bordered">
					<thead>
					...
					<tbody class="tbody-datos-asignar"></tbody>
				</table>
				<hr>
...
<script>
    ...
    var label_sin_clasificar = '<?= lang('Home.Sin clasificar'); ?>';
    var label_comun = '<?= lang('Home.Común'); ?>';
    var label_hibrido = '<?= lang('Home.Híbrido'); ?>';
    var label_esporadico = '<?= lang('Home.Esporádico'); ?>';
