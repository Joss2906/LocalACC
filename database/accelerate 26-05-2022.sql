...
-- Tiempo de generación: 26-05-2022 a las 22:29:55
...
INSERT INTO `satisfaction_categories` (`satisfaction_category_id`, `category`) VALUES
(1, 'Credibilidad'),
(2, 'Respeto'),
(3, 'Imparcialidad'),
(4, 'Orgullo'),
(5, 'Compañerismo'),
(6, 'Preguntas Adicionales de México'),
(7, 'Adicional Cliente');
...
(1936, 2, 2, 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga.', 2, '2022-05-26 16:36:25', NULL, NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `satisfaction_response_ratings` (
  `satisfaction_response_rating_id` int(11) NOT NULL,
